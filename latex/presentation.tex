...
% \setbeamertemplate{navigation symbols}{} doesn't work
...
% Don't ask to ask questions, as questions will be asked a bit later,
% not immediately after the presentation.

\begin{frame}{Opponent's questions}
    \begin{itemize}
        \item Your thesis is so great, how did u do it?
    \end{itemize}
    \note{remove this shit}
\end{frame}
